...
/// Nvidia provider — wraps the OpenAI-compatible provider with Nvidia's base URL.
...
impl NvidiaProvider {
    pub fn new(
        ...
        let base = base_url.unwrap_or_else(|| "https://integrate.api.nvidia.com/v1".to_string());
        Self {
...
#[async_trait]
impl TextProvider for NvidiaProvider {
