...
/// OpenCode provider — wraps the OpenAI-compatible provider with OpenCode's base URL.
...
impl OpenCodeProvider {
    pub fn new(
        ...
        let base = base_url.unwrap_or_else(|| "https://opencode.ai/zen/v1".to_string());
        Self {
...
#[async_trait]
impl TextProvider for OpenCodeProvider {
